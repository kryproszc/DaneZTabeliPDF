...
#### uruchamiam program
            ...
            time_start<-Sys.time()
              out_data<-zwroc_test(exponsure_longitude,exponsure_latitude,list_list_wyb,fire_spread_prob_vec,conditional_mean_trend_parameters,conditional_Cov,exponsure_insurance,exponsure_reassurance,
                                   exponsure_sum_value,wielkosc_pozaru,fakultatywna_input_num,fakultatywna_input_val,obligatoryjna_input_risk,obligatoryjna_input_event,1,5000000,4)
